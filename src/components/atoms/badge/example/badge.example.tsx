...
export const BadgeExample: React.FC = () => {
  const [dismissedBadges, setDismissedBadges] = useState<Set<string>>(
    new Set()
  );
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Explore different variants, sizes, and features of the Badge
            component
          </p>
        </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  <Badge variant="info" icon={<FaInfoCircle />}>
                    Info
                  </Badge>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  <Badge variant="primary" icon={<FaBell />} showDot size="sm">
                    New
                  </Badge>
                  <Badge variant="success" icon={<FaCheck />} rounded>
                    Verified
                  </Badge>
                  <Badge
                    variant="warning"
                    ...
                    clickable
                    onClick={() => handleClick("Warning badge clicked!")}
                  >
                    Clickable
                  </Badge>
                </div>
        ...
        <section className="mb-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge variant="error" showDot size="sm">
                Suspended
              </Badge>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge variant="error" size="sm" icon={<FaBell />}>
                3
              </Badge>
              <Badge variant="warning" size="sm" icon={<FaBell />}>
                5
              </Badge>
              <Badge variant="info" size="sm" icon={<FaBell />}>
                12
              </Badge>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Badge variant="error" size="sm" icon={<FaTimes />}>
                Disconnected
              </Badge>
              <Badge
                variant="warning"
