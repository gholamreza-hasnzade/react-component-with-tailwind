...
// Clipboard variants using cva - matching button component exactly
  ...
  "inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-60",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        color: "warning",
        className:
          "border-yellow-500 text-yellow-600 hover:bg-yellow-600 active:bg-yellow-100 disabled:text-yellow-400 disabled:border-yellow-400",
      },
      {
        variant: "outlined",
        color: "info",
