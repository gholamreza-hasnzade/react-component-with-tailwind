  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        {/* Avatar Groups */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Avatar Groups</h2>
          
          {/* Stack Variant */}
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Stack Variant</h3>
            <div className="flex items-center space-x-8">
              <div className="text-center">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Normal Spacing</h4>
                <div className="flex">
                  {[
              ...
              <div className="text-center">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Tight Spacing</h4>
                <div className="flex">
                  {[
                    ...
                    { name: "Lisa Garcia", initials: "LG", color: "success" as const },
                    { name: "David Lee", initials: "DL", color: "warning" as const },
                  ].map((user, index) => (
                    <Avatar
                      key={index}
                      color={user.color}
          ...
          {/* Grid Variant */}
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Grid Variant</h3>
            <div className="flex items-center space-x-8">
              <div className="text-center">
                <h4 className="text-sm font-medium text-gray-700 mb-2">3x2 Grid</h4>
              ...
              <div className="text-center">
                <h4 className="text-sm font-medium text-gray-700 mb-2">2x2 Grid</h4>
                <div className="grid grid-cols-2 gap-2 w-24">
                  {[
                    ...
                    { name: "Guest", initials: "G", color: "secondary" as const },
                  ].map((user, index) => (
                    <Avatar
                      key={index}
                      color={user.color}
          ...
          {/* List Variant */}
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-800 mb-4">List Variant</h3>
            <div className="flex items-center space-x-8">
              <div className="text-center">
                <h4 className="text-sm font-medium text-gray-700 mb-2">Vertical List</h4>
                <div className="flex flex-col space-y-2 w-24">
                  {[
                    { name: "Team Lead", initials: "TL", color: "primary" as const },
                    { name: "Developer", initials: "DEV", color: "success" as const },
                    { name: "Designer", initials: "DES", color: "warning" as const },
              ...
              <div className="text-center">
                <h4 className="text-sm font-medium text-gray-700 mb-2">With Status</h4>
                <div className="flex flex-col space-y-2 w-24">
                  {[
                    { name: "Online User", initials: "OU", status: "online" as const },
                    { name: "Away User", initials: "AU", status: "away" as const },
                    { name: "Busy User", initials: "BU", status: "busy" as const },
                    { name: "Offline User", initials: "OU", status: "offline" as const },
                  ].map((user, index) => (
                    <Avatar
                      key={index}
                      color="default"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-medium text-blue-900">Project Team</span>
                  <div className="flex">
                    {[
                      { name: "John", initials: "J", color: "primary" as const },
                      { name: "Jane", initials: "J", color: "success" as const },
              ...
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-medium text-green-900">Design Team</span>
                  <div className="flex">
                    {[
                      { name: "Sarah", initials: "S", color: "success" as const },
                      { name: "Mike", initials: "M", color: "primary" as const },
                      { name: "Lisa", initials: "L", color: "warning" as const },
                      { name: "David", initials: "D", color: "info" as const },
                      { name: "Emma", initials: "E", color: "secondary" as const },
                    ].map((user, index) => (
                      <Avatar
                        key={index}
                        color={user.color}
...
>
  +2
            ...
            <div>
              <h3 className="font-medium text-yellow-300 mb-2">Group Variants:</h3>
              <pre className="bg-gray-800 p-3 rounded overflow-x-auto">
...
<Avatar group groupSpacing="loose" />    // -ml-4`}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">"More" Functionality Examples</h2>
          
          {/* Large Team with More Button */}
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Large Team with More Button</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-medium text-blue-900">Development Team (12 members)</span>
                  <div className="flex">
                    {[
                      { name: "John", initials: "J", color: "primary" as const },
                      { name: "Jane", initials: "J", color: "success" as const },
                      { name: "Bob", initials: "B", color: "warning" as const },
                      { name: "Alice", initials: "A", color: "info" as const },
                      { name: "Mike", initials: "M", color: "secondary" as const },
                      ...
                      <Avatar
                        ...
                        groupMax={6}
                        showGroupMore
                        onGroupMoreClick={() => handleMoreClick("Development Team", 6)}
                        clickable
                        onClick={() => handleAvatarClick(user.name)}
                      >
                        {user.initials}
              ...
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-medium text-green-900">Design Team (8 members)</span>
                  <div className="flex">
                    {[
                      { name: "Lisa", initials: "L", color: "success" as const },
                      { name: "David", initials: "D", color: "primary" as const },
                      { name: "Emma", initials: "E", color: "warning" as const },
                      ...
                      <Avatar
                        ...
                        groupMax={4}
                        showGroupMore
                        onGroupMoreClick={() => handleMoreClick("Design Team", 4)}
                        clickable
                        onClick={() => handleAvatarClick(user.name)}
                      >
                        {user.initials}
              ...
              <div className="flex items-center justify-between p-4 bg-purple-50 rounded-lg">
                <div className="flex items-center space-x-3">
                  <span className="text-sm font-medium text-purple-900">QA Team (15 members)</span>
                  <div className="flex">
                    {[
                      { name: "Tom", initials: "T", color: "primary" as const },
                      { name: "Anna", initials: "A", color: "primary" as const },
                      { name: "Paul", initials: "P", color: "success" as const },
                      { name: "Paul", initials: "P", color: "success" as const },
                      { name: "Paul", initials: "P", color: "success" as const },
                      { name: "Paul", initials: "P", color: "success" as const },
                      { name: "Paul", initials: "P", color: "success" as const },
            ...
            <p className="text-sm text-gray-600 mt-4">
              💡 <strong>Hover over the "+" buttons to see them lift up!</strong> Click them to see console output.
              Open your browser's developer console (F12) to see the logged information.
            </p>
          </div>

                  {/* Console Output Display */}
        <div className="mb-8">
          <h3 className="text-lg font-medium text-gray-800 mb-4">Console Output Examples</h3>
          <div className="bg-gray-900 p-4 rounded-lg text-white">
            ...
            <div className="bg-gray-800 p-3 rounded text-sm font-mono space-y-1">
              <div className="text-green-400">🔄 More clicked for [Team Name]</div>
              <div className="text-blue-400">📊 Hidden members count: [Number]</div>
              <div className="text-yellow-400">👥 Team: [Team Name] has [Number] hidden members</div>
              <div className="text-purple-400">👤 Avatar clicked: [Member Name] (when clicking individual avatars)</div>
            </div>
          ...
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Implementation Guide</h3>
            <div className="space-y-4">
              <div>
                <h4 className="text-md font-medium text-gray-700 mb-2">1. Basic Console Logging</h4>
...
{`const handleMoreClick = (teamName, hiddenCount, hiddenMembers) => {
  ...
  console.log('Hidden members:', hiddenMembers);
              ...
              <div>
                <h4 className="text-md font-medium text-gray-700 mb-2">2. Modal Approach</h4>
                <pre className="bg-gray-100 p-3 rounded text-sm overflow-x-auto">
{`const handleMoreClick = (teamName, hiddenCount, hiddenMembers) => {
  setShowModal(true);
  ...
  setHiddenMembers(hiddenMembers);
              ...
              <div>
                <h4 className="text-md font-medium text-gray-700 mb-2">3. Navigation Approach</h4>
                <pre className="bg-gray-100 p-3 rounded text-sm overflow-x-auto">
{`const handleMoreClick = (teamName, hiddenCount, hiddenMembers) => {
  ...
  window.open(\`/teams/\${teamName.toLowerCase().replace(' ', '-')}\`, '_blank');
              ...
              <div>
                <h4 className="text-md font-medium text-gray-700 mb-2">4. Analytics Tracking</h4>
                <pre className="bg-gray-100 p-3 rounded text-sm overflow-x-auto">
{`const handleMoreClick = (teamName, hiddenCount, hiddenMembers) => {
  // Track analytics
  ...
  console.log('Analytics tracked, handling more click...');
        ...
        {/* Live Debug Logs */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6">Live Debug Logs</h2>
          <div className="bg-gray-900 p-4 rounded-lg text-white">
            <p className="text-sm text-gray-300 mb-3">
            ...
            <div className="mt-3 text-xs text-gray-400">
              💡 This shows the same logs that appear in the browser console (F12 → Console tab)
            </div>
          </div>
        </div>
      </div>
